...
class ImageCommentsUIIntegrationTests: FeedUIIntegrationTests {
	...
	override func test_feedImageView_loadsImageURLWhenVisible() {
		...
		sut.loadViewIfNeeded()
		loader.completeImageCommentsLoading(with: [image0, image1])
	...
	override func test_feedImageViewLoadingIndicator_isVisibleWhileLoadingImage() {
		...
		sut.loadViewIfNeeded()
		loader.completeImageCommentsLoading(with: [makeImage(), makeImage()])
	...
	override func test_feedImageViewRetryButton_isVisibleOnInvalidImageData() {
		...
		sut.loadViewIfNeeded()
		loader.completeImageCommentsLoading(with: [makeImage()])
	...
	private func makeSUT(
		...
		let sut = ImageCommentsUIComposer.feedComposedWith(

//
//  ImageCommentUIIntegrationTests.swift
//  EssentialAppTests
//
...
class ImageCommentUIIntegrationTests: XCTestCase {
	...
	private func makeSUT(file: StaticString = #file, line: UInt = #line) -> (sut: ImageCommentViewController, loader: LoaderSpy) {
		let loader = LoaderSpy()
		let sut = ImageCommentUIComposer.imageCommentComposedWith(loader: loader)

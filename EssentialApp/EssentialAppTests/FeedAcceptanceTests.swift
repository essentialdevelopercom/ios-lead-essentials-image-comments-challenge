...
class FeedAcceptanceTests: XCTestCase {
	...
	func test_onSelectImage_showsImageCommentsForOnlineCustomer() {
		let comments = showCommentsForFirstImage(httpClient: .online(response))

		XCTAssertEqual(comments.numberOfRenderedImageCommentsImageViews(), 1)

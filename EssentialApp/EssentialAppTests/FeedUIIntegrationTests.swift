...
final class FeedUIIntegrationTests: XCTestCase {
	...
	func test_selectFeedImage_callOnImageSelection() {
		var selectedImages = [FeedImage]()
		let (sut, loader) = makeSUT() { feedImage in
			selectedImages.append(feedImage)
		}
		...
		sut.simulateUserSelectFeedImage(at: 0)
		sut.simulateUserSelectFeedImage(at: 1)

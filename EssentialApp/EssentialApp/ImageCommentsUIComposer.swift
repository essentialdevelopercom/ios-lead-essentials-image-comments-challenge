...
final class ImageCommentsUIComposer {
	static func imageCommentsComposedWith(imageCommentsLoader: @escaping () -> ImageCommentsLoader.Publisher, relativeDate: @escaping () -> Date) -> ImageCommentsViewController {

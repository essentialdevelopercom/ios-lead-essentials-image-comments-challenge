//
//  FeedImageCommentsLocalizationTests.swift
//  EssentialFeedTests
//
...
class FeedImageCommentsLocalizationTests: XCTestCase {

	func test_localizedStrings_haveKeysAndValuesForAllSupportedLocalizations() {
		let table = "FeedImageComments"
		let presentationBundle = Bundle(for: FeedImageCommentsPresenter.self)

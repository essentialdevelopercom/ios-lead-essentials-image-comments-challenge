...
protocol LocalizationTests: XCTestCase {}

extension LocalizationTests {

	func checkAllStringsHaveKeysAndValuesForAllSupportedLanguages(in table: String, for bundle: Bundle, file: StaticString = #filePath, line: UInt = #line) {

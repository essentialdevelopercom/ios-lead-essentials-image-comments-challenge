...
public class ImageCommentsPresenter {
	...
	public init(imageCommentsView: ImageCommentsView, loadingView: ImageCommentsLoadingView, errorView: ImageCommentsErrorView, currentDate: @escaping () -> Date = Date.init) {
